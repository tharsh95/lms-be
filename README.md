...
A production-ready Node.js boilerplate using TypeScript, Express, and MongoDB.
...
- **MongoDB with Mongoose** - Elegant MongoDB object modeling for Node.js
- **Environment Variables** - Using dotenv for environment variables
- **Error Handling** - Centralized error handling mechanism
- **API Validation** - Request data validation
- **Nodemon** - Automatic server restart during development
- **Type Definitions** - Custom type definitions for improved type safety
- **Clean Architecture** - Controllers, routes, models, and middleware separation
...
- `npm run lint` - Run TypeScript compiler to check for errors
- `npm run clean` - Remove the dist directory
